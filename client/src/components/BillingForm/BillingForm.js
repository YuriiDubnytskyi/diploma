...
const BillingForm = ({name,surname,email,city,novaPosta,phone,note,error,
    setName,setSurname, setCity,setNovaPosta,setPhone,setNote,onFinish
}) => {
    return (
        <div className='billing__form'>
            ...
            <p className='billing-submit' onClick={onFinish}>Submit</p>
        </div>
    )
}

        ...
        <div className='product__container product-container '>
            ...
            <div className='product-short-info'>
                ...
                <div className='product-short-info-btn'>
                    <p className='product-short-info-buy' onClick={()=>addBuy(data.idProduct,user.bucketProducts)}><i className="fa fa-shopping-bag"></i>add to cart</p>
                    <p className='product-short-info-like' onClick={()=>likeProduct(data.idProduct,user.likeProducts)}><i className="fa fa-heart"></i></p>
                </div>
                <hr className='product-short-info-line'/>

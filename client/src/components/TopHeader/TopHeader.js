            ...
            <div className='top-header__content content-top'>
                <div className='content-top__call call-support'>
                    <p className='call-support__info'>
                        ...
                        <a className='call-support__phone' href='tel:0687516148'> +38 068 75 16 148 </a>
                         for support.
                    </p>
                    <p className='call-support__info--responce'>
                        Vulka Electronic
                    </p>
                </div>
                <div className='content-top__auth auth'>
                    {props.auth ?
                        <Link className='auth-account' to='/account'><i className="fa fa-user-circle"></i>Account</Link>
                    :<>
                        <Link className='auth-login' to='/login'>Login</Link>
                        <Link className='auth-sign' to='/login'>Sign up</Link>
                    </>
                    }

        ...
        <div  className='settings account__settings'>
            <div  className='settings-box'>
                <h3 className='settings-title'>Setting</h3>
                    ...
                    <p className='settings-submit' onClick={saveChange}>Save Changes</p>
            </div>
            <div className='setting-box-options'>
                <div  className='settings-box-email'>
                    ...
                    :<>
                        ...
                        <p className='email-support-btn' onClick={goVerify}>Verify</p>
                        {
                        sendEmail?
                            <p className='email-support-send'>Please go to your email box</p>
                        :<></>
                        }
                    </>
                    }

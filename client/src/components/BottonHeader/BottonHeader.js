            ...
            <div className='botton-header__content content-botton'>
                ...
                <div className='content-botton__nav header-nav'>
                    <nav className='header-nav__navigation navigation'>
                        ...
                        <Link className='navigation-link' to='/categorie'>Categories</Link>
                ...
                <div className='content-botton__btns btns-container'>
                    <input className='btns-container__input' placeholder='Search' value={props.searchValue} onChange={(e)=>props.setSearchValue(e.target.value)}/>
                    <i className="fa fa-search" onClick={props.searchSubmit}></i>
                    <Link className='btns-container-link' to='/like'><i className="fa fa-heart"></i></Link>
                    <Link className='btns-container-link' to='/bucket'><i className="fa fa-shopping-bag"></i></Link>
                </div>
            </div>
        </div>
    )
